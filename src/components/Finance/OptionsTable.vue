<template>
    <section class="container-options">
        <ul class="list-options">
            ...
            <li class="option" @click="handleChangeTab('important')" :class="{ active: tabActive === 'important' }">
                Importantes
                <span class="number">{{ numberImportant }}</span>
            </li>
            <li class="option" @click="handleChangeTab('draft')" :class="{ active: tabActive === 'draft' }">
                Pausados
